<?php
	namespace Service\Find\VideoFind;

	require_once('Service/Find/VideoFind.class.php');
	
	/**
	* Class represening the find box for random videos
	*/
	class Random extends \Service\Find\VideoFind {
		...
		*/
		public function __construct( $category, $invalid_id, $mysqli ) {
			...
			\Service\Find\VideoFind::__construct( "", "random", $category, 1, 6, $mysqli );
