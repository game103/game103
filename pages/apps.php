<?php
	...
	$select_str = "SELECT apps.name as name, apps.description, apps.url_name, apps.image_url, apps.store_url, apps.type FROM apps ORDER BY added_date ASC";
	...
	$select_statement->bind_result($name, $description, $url_name, $image_url, $store_url, $type);
