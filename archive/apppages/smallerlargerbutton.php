...
<html>
	<head>
		<!-- Meta Tags -->
		<meta name = 'description' content = 'Generate buttons to make content on your website smaller or larger.'>
		...
		<!-- Title -->
		<title>Game 103: Smaller & Larger Buttons</title>
	...
	<body>
		<div class = 'page'>
			...
			<h1 style='position:absolute;top:-5px;text-align:center;width:880px;' title = 'Thanks for visiting!'>Game 103: Smaller & Larger Buttons</h1>
			...
			<div class = 'content' style = 'text-align:center;'>
				On this page, you can create buttons that allow users on your site to make page elements larger and smaller (as seen on the Game 103 game pages).
